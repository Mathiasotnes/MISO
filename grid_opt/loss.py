...
from .models.grid_ash import GridASH
...
class MisoLossMapping(MisoLossMappingBase):
    ...
    def query_kf_pose(self, model, kf_id):
        assert \
            isinstance(model, GridNet) or \
            isinstance(model, GridNGP) or \
            isinstance(model, GridNGPOurs) or \
            isinstance(model, NeuralPoints) or \
            isinstance(model, GridASH), \
